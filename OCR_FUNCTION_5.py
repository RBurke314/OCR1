...
contouring, convex hull, masking
try these steps using links, or try enhance grayscale to refine OCRFUNCTION%

Easier to remnove noise from grayscaled image rather than thresholded one
"""
...
#source = r'C:/Users/Rob/dev/VisionSystems/OCR/OCR1/DataBase/test/test_snippet_3.tif'
...
if __name__ == '__main__':
    while True:
        ...
        # ///////Resize//////////////////////////////
        resized = resizeImage(passed, sfactor, interpol[3])#Resize image
        # /////////////////////////////////////
        passed = resized
        # /////Normalise///////////////////////
        ...
        """median = cv2.medianBlur(passed, 1)
        print 'Blurred'
        passed = median"""
        """# /////Normalise///////////////////////
