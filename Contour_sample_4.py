...
image, contours, hierarchy = cv2.findContours(imgBW.copy(), cv2.RETR_LIST,
...
image,contoursFinal,hierarchyFinal = cv2.findContours(imgClose.copy(), cv2.RETR_LIST,
    cv2.CHAIN_APPROX_NONE)
