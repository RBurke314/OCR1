...
# Attempt to clean image/ reduce noise before grayscale******************
        ...
        #***********Add Median blur inter area? resize convert to tiff
"""
...
source = r'C:/Users/Rob/dev/VisionSystems/OCR/OCR1/DataBase/test/test_snippet_5.png'
#source = r'C:/Users/Rob/dev/VisionSystems/OCR/OCR1/DataBase/rob_img_pack/set 1/imgcheck.png'
...
def threshold(image, state):
    while (1):
        ...
        stack = cv2.resize(stack, (0, 0), fx=1.5, fy=1.5)
...
if __name__ == '__main__':
    while True:
        ...
        dst = cv2.fastNlMeansDenoisingColored(passed, None, me, me, me, me)
        print ', Denoised'
        passed = dst
        # ///////Resize//////////////////////////////
        resized = resizeImage(passed, sfactor, interpol[3])
        # /////////////////////////////////////
        passed = resized
        #/////Grayscale//////////////////////
        ...
        cv2.createTrackbar(TrackbarName1, 'Threshold', 44, 400, nothing) #33
        cv2.createTrackbar(TrackbarName2, 'Threshold', 83 , 100, nothing)#82
        state = 0
